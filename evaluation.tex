...
\approach~with gpt-5.1 gives the best result, successfully reproducing the expected table in 40 out of the 60 tasks (20 full reproduction and 20 last-mile reproduction).
...
We manually analyze 20 cases where~\approach~with gpt-5.1 fails to reproduce the expected table.
Our manual analysis reveals that~\todo.
