...
This addresses limitations of prior benchmarks~\cite{super,corebench,reprobench}, which we find do not fully mirror artifact evaluation as practiced in the software engineering community.
...
We first give general criteria (Section~\ref{s:task_selection_criteria}).
...
Unlike previous work~~\cite{super,corebench} we allow submission and getting the feedback whle agent is running.
