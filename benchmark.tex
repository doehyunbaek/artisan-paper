...
Papers in the Others include one for Fuzzing, one for Mutation Testing, one for Model-based Testing, one for Mobile Applications, one for Program Repair, one for Test Automation, and one for AI for Software Engineering.
