...
Only non-deterministic parts are filtered out to get the partial table for the subsets.
...
Previous benchmarks are limited in both software engineering techniques (ML / NLP) and programming languages (Python, R, and Stata).
\benchmark~covers diverse software engineering techniques (e.g., Empirical Study, Security, Fuzzing, Static Analysis, Dynamic Analysis) and programming languages (Python, Java, Rust, OCaml, Scala, Bash, C).
