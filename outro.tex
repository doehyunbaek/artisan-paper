...
Winter et al.~\cite{DBLP:conf/sigsoft/0001T0C0H022} studies what impact artifact evaluation process has on artifacts and find that although artifacts that underwent artifact evaluation do not have better visibility, it is more available, documented, and maintained.
