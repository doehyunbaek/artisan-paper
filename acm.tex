...
\newcommand\goodscripttsize{40}
\newcommand\goodscripttsizeoutperform{2.86}
...
Our experiments show that \approach~is effective, producing \goodscripttsize{} new \goodscript{}~and outperforming the baseline by \goodscripttsizeoutperform{}$\times$, while taking~\artisancost~and~\artisantime~on average per task.
